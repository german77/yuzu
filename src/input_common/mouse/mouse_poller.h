...
public:
    explicit MouseButtonFactory(std::shared_ptr<InputCommon::Mouse> mouse_input_);
...
private:
    std::shared_ptr<InputCommon::Mouse> mouse_input;
    bool polling = false;
};
...
public:
    explicit MouseAnalogFactory(std::shared_ptr<InputCommon::Mouse> mouse_input_);
...
public:
    explicit MouseMotionFactory(std::shared_ptr<InputCommon::Mouse> mouse_input_);
...
public:
    explicit MouseTouchFactory(std::shared_ptr<InputCommon::Mouse> mouse_input_);
